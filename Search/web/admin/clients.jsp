						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                      ...
                                                      for (int x=0;x<c;x++){
                                                          ...
                                                          String update="updateclient.jsp?id="+website.get(0);
                                                          String delete="deleteclient.jsp?id="+website.get(0);
                                                      %>
							<tr>
                                                            <td><% out.print(website.get(1)); %></td>
                                                            <td><% out.print(website.get(2)); %></td>
							    <td class="center"><% out.print(website.get(3)); %></td>
